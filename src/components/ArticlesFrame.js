...
class CardFrame extends Component {
  state={
    people: [
      ...
      {name: "VLC installation", demo: ["Update local package list", "Install VLC"], likes: ["~$ sudo apt-get update", "~$ sudo apt-get install vlc"], contribute: ["Tanzeel Mirza, Admin"], image: "vlc.jpg"},
